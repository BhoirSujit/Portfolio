            ...
            <div className="body flex h-full">
              ...
              <div className="editor w-full">
                <div className="file border-b w-full">
                  <ul className="flex ">
                    <li className="border-r p-1">Sujit.ts ⨉</li>
                  </ul>
                </div>
                <div className="bodyeditor flex">
                  ...
                  <div className="e">
                    ...
                    <p>console.log(`your can call me $&#123;name.split(' ')[0]&#125;`);</p>
...
<p>&#125;</p>
        ...
        <div className="p-10 flex order-1 flex-col lg:order-2  w-full">
          ...
          <div>
            A motivated Computer Science graduate from Mumbai University seeking
            a software development position to leverage my programming skills
            and project experience in a dynamic tech environment
          </div>
        </div>
      </div>
      <hr />
