...
export default function Contact() {
  ...
  const handleOnSumbit = (event: FormEvent) => {
    ...
    emailjs
      .send('service_5vfnpo2', 'template_rqmsvdc', templateParams, {
        publicKey: 'EGSLYihmuLIgXvVB2',
      })
      .then(
        () => {
          console.log('SUCCESS!');
        ...
        (error) => {
          ...
          alert('message faild to receive');
        },
      );
  ...
  return (
    <section id="contact" className="mx-0 lg:mx-20 lg:py-0 xl:mx-32 xl:py-10">
          ...
          <div className="flex flex-col justify-center h-full">
            <ul className="*:flex *:gap-4 flex flex-col gap-4">
              <li>
                ...
                <div>sujitbhoir004@gmail.com</div>
              </li>
              <li>
                <div>
                  <svg
            ...
            <ul className="handles flex mt-4 gap-2">
              <li>
