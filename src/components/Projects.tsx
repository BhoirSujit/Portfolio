...
const data: projectdata[] = [
  {
    name: "Campus Diary",
    des: "campus social networking app",
    photo: "campusdiary.png",
    links: {
  ...
  },
  {
    ...
    photo: "makeatour.png",
    links: {
      github: "https://github.com/BhoirSujit/GupShup",
    },
  }
  ,
  {
    name: "TakeNoteApp",
    des: "simple todo app for learning",
    photo: "makeatour.png",
    links: {
      github: "https://github.com/BhoirSujit/TakeNoteApp",
    },
  },
  {
    name: "Text Summariser",
    des: "build with ntlk and T5 model pytorch and tkinter",
    photo: "textsummerizer.png",
    links: {
...
function ProjectView({ ...props }: projectdata) {
  return (
    <div className="w-full relative border p-2 rounded-2xl shadow-md">
      <div className="photo border rounded-2xl h-52 md:h-80 lg:h-64 xl:h-96 overflow-hidden">
        <img
          className="w-full h-full object-cover hover:scale-105 transition-all ease-in-out delay-100"
          src={props.photo}
          alt="img"
        />
      </div>
      <div className="name flex justify-between items-center p-2">
        <div  className="py-2">
          <h3 className="text-lg font-semibold">{props.name}</h3>
          <h3 className="">{props.des}</h3>
        </div>
